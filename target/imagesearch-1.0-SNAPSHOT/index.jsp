            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="#">电商识图文档</a></li>
                        <li role="presentation" class="divider"></li>
                        <li><a href="#">以图搜图文档</a></li>
                        <li role="presentation" class="divider"></li>
                        <li><a href="#">图像分类文档</a></li>
                    </ul>
                </li>
            </ul>
                    ...
                    <div>
                        <%
                            ...
                            if (session.getAttribute("email")!=null){
                                %>
                        <button type="button" class="btn btn-primary btn-lg" onclick=" location.href='./jsp/applyeb.jsp'">立刻加入</button>

                        <%
                            }else {
                                %>
                        <button type="button" class="btn btn-primary btn-lg" onclick=" location.href='./jsp/login.jsp'">立刻加入</button>
            ...
            <div role="tabpanel" class="tab-pane" id="tab-tellimg">
                <div class="row feature">
                    <div class="col-md-7">
                        ...
                        <h2 class="feature-heading">以图搜图<span
                    ...
                    <div>
                        <button type="button" class="btn btn-primary btn-lg">立刻加入</button>
                    </div>
                </div>
            ...
            <div role="tabpanel" class="tab-pane" id="tab-sort">
                <div class="row feature">
                    <div class="col-md-7">
                        ...
                        <p class="lead">我们可以定义我们的分类标准，比如有车的一类，有房子的一类，或者以颜色来分类，让我们可以更好的真理我们的大量图片。从此不再需要担心杂乱无章的图片让人心烦</p>
                    </div>
